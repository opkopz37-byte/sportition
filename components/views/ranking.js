            ...
            <div className="flex items-center gap-2 xs:gap-2.5 sm:gap-3">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1 xs:gap-1.5 sm:gap-2 mb-0.5 xs:mb-1">
                  <span className="px-1.5 py-0.5 xs:px-2 rounded-full text-[8px] xs:text-[9px] sm:text-[10px] font-bold bg-red-500/20 text-red-400 border border-red-500/30 whitespace-nowrap">
                    {t('athlete')}
                  </span>
                  <div className="text-sm xs:text-base sm:text-lg font-bold text-white truncate">김태양</div>
                </div>
                <div className="flex items-center gap-1 xs:gap-1.5 sm:gap-2">
                  <div className="px-1.5 xs:px-2 sm:px-2.5 py-0.5 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 text-black text-[9px] xs:text-[10px] sm:text-xs font-bold whitespace-nowrap">
                    Diamond II
                  </div>
                </div>
              </div>
        ...
        <div className="divide-y divide-white/5">
          {paginatedMembers.map((member, idx) => {
            ...
            return (
              <div
                key={member.rank}
                className={`px-2 xs:px-3 sm:px-4 py-2.5 xs:py-3 transition-all hover:bg-white/5 ${
                ...
                <div className="sm:hidden">
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <div className="text-left">
                          <div className="font-bold text-white text-sm hover:text-blue-400 transition-colors">{member.name}</div>
                          <div className="text-[9px] text-gray-500">Lv.{member.level}</div>
                        </div>
                      </button>
                    </div>
                    ...
                    <div className="text-right">
                      <div className="text-lg font-bold text-blue-400">{member.points.toLocaleString()}</div>
                  ...
                  <div className="flex items-center justify-between gap-2 text-[10px]">
                    ...
                    <div className={`inline-flex px-2 py-1 rounded-lg bg-gradient-to-r ${tierColor.bg} border ${tierColor.border}`}>
                      <span className={`font-bold ${tierColor.text} whitespace-nowrap`}>{member.tier}</span>
                    </div>
                    
                    {/* 승률 */}
                    <div className="flex items-center gap-2 text-gray-400">
                      <span>승률 {member.winRate}%</span>
                      <span>•</span>
                      <span>출석 {member.attendance}일</span>
                    </div>
                  </div>
                </div>
