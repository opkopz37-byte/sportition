...
(3,'원투','One-Two','tutorial',55,45,'basic',ARRAY[1]),
(4,'가드 자세','Guard Position','tutorial',45,55,'basic',ARRAY[1]),
(5,'풋워크 기초','Basic Footwork','tutorial',55,55,'basic',ARRAY[1]),
(10,'근력 강화','Strength Training','infighter',35,40,'basic',ARRAY[1]),
...
(30,'스피드 훈련','Speed Training','outboxer',65,60,'basic',ARRAY[1]),
